...
import ParkingDetailSidebar from '../../components/Parking/ParkingDetailSidebar';
...
const ParkingSpotPage = () => {
    ...
    const selectedParking = mapParkings.find(p => p.id === selectedParkingId) || null;
    ...
    return (
        <div className="flex flex-col h-screen overflow-hidden font-sans bg-white">
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                {/* Map Area */}
                <div className="hidden lg:block flex-1 relative bg-slate-100 z-0 overflow-hidden">
                    <ParkingFinderMap 
