                ...
                <div className="session-content">
                    {sessionLoading && (
                        <div className="session-loading">
                            <div className="spin" />
                            Loading parking session information...
                        </div>
                    )}
                        ...
                        <div className="dashboard-panel">
                            ...
                            <div className="stat-grid s-in-1">
                                <div className="stat-card blue">
                                    ...
                                    <div className="stat-sub blue">Hours : Minutes : Seconds</div>
                                </div>
                            ...
                            <div className="s-card s-in-2">
                                <div className="location-row">
                                    ...
                                    <div>
                                        <div className="location-label">Parking Location</div>
                                ...
                                <div className="details-grid">
                                    <div>
                                        <div className="detail-item-label">Parking Area</div>
                                ...
                                <div className="pricing-details">
                                    <div className="pricing-row">
                                        <span className="pricing-label">Additional Fee (4-hour Block)</span>
                                        <span className="pricing-value" style={{ color: '#2563eb' }}>{fmtVND(blockRate)} / block</span>
                                    </div>
                                    {vehicleTypeData?.pricing?.dailyRate && (
                                        <div className="pricing-row">
                                            <span className="pricing-label">Max Daily Rate</span>
                                    ...
                                    {advancePayment > 0 && (
                                        <div className="pricing-row">
                                            <span className="pricing-label" style={{ color: '#10b981' }}>Pre-paid (Booking)</span>
